        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-800 text-white py-4 rounded-lg hover:bg-blue-900 transition-colors duration-200 font-medium"
              >
                Nachricht senden
              </button>
            </form>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+49 (0) 123 456 790</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@abwasser-technik.com</p>
                  <p className="text-gray-600">service@abwasser-technik.com</p>
                </div>
              </div>
